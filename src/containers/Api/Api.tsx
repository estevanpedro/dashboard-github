...
const Api = () => {
  return (
    <Container>
      ...
      <Text>
      To create a scheme, use post in /scheme endpoint passing, <CodeText>name</CodeText>, <CodeText>payout</CodeText>, <CodeText>visibility</CodeText>, <CodeText>tree</CodeText> in the <CodeText>root</CodeText> object, and the Splitmaster Token as showed in the Postman Documentation.
      </Text>
